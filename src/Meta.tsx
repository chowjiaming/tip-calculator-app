...
Meta.defaultProps = {
  ...
  description: 'A tip calculator app - frontend challenge by Frontend Mentor',
  imageSource: 'https://imgur.com/Zl7DQPe',
  imageType: 'image/png',
  imageAltText: 'A tip calculator app - frontend challenge by Frontend Mentor',
  imageWidth: '1920',
  imageHeight: '926',
  type: 'website',
  websiteUrl: 'https://tip-calculator-app-chowjiaming.netlify.app/',
